...
!function(a) {
	...
	k.prototype = {
		constructor: k, _resolveViewName: function(a, c) {
			...
			for (var c, d, e, f = 0; f < a.length; f++)c = a[f][0], 2 === a[f].length ? (d = b, e = a[f][1]): 3
			===
			a[f].length && (d = a[f][1], e = a[f][2]), c.on(e, d)
		}, _unapplyEvents: function(a) {
			for (var c, d, e, f = 0; f < a.length; f++)c = a[f][0], 2 === a[f].length ? (e = b, d = a[f][1]): 3
			===
			a[f].length && (e = a[f][1], d = a[f][2]), c.off(d, e)
			...
			this.element.trigger({
				...
				format: a.proxy(function(a, b) {
					...
					==
					typeof a && (b = a, a = this.dates.length - 1), b = b || this.o.format;
